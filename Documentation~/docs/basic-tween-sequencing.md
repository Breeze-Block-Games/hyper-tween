...
[!code-csharp[CS](../../Samples~/Examples/MonoBehaviours/SequenceTweenExample.cs)]
...
A very useful pattern to employ when working with such structures is to create methods that return `TweenHandle`, then combine them into sequences. This can help to simplify your code and allow you to reuse methods for the creation of tweens:

[!code-csharp[CS](../../Samples~/Examples/MonoBehaviours/CompositionTweenExample.cs)]