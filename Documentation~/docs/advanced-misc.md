...
As tweens are only processed once per frame, tweens will always last for slightly longer than their duration. When tweens are added to sequences, HyperTween automatically causes subsequent tweens to skip this portion of their duration such that the duration of the total sequence is more accurate.
